...
Perform a `/code-review-adversarial` using instructions supplied to this skill.
...
Perform a followup review of how concerns in `code-review.md` were addressed by `code-review-followup.md` and a diff of the followup changes. Have the `implementer` address any further followup changes needed.
